 ...
 * The "sin" operator.
 * <p>
 * This operator pops a number from the stack, computes its sine (interpreting the number as an angle in degrees), and
 * returns that value to the stack.
 */
public final class SinOperator extends AbstractOperator {

    /**
     * Constructs a new {code SinOperator}.
     */
    public SinOperator() {
    ...
    public final void execute(final OperatorStack stack) throws OperatorException {
        ...
        if (arg == null) {
            throw new OperatorException(EOperatorExceptionType.STACK_UNDERFLOW,
                    "[sin] operation executed when stack is empty.");
        }
