 ...
 * The "xor" operator.
 * <p>
 * This operator pops two values from the stack.  If they are both Boolean, it computes their logical XOR, and returns
 * that Boolean value to the stack.  If they are both Integers, it computes their bitwise XOR and returns that integer
 * value to the stack.
 */
public final class XorOperator extends AbstractOperator {

    /**
     * Constructs a new {code XorOperator}.
     */
    public XorOperator() {
    ...
    public final void execute(final OperatorStack stack) throws OperatorException {
        ...
        if (arg1 == null || arg2 == null) {
            throw new OperatorException(EOperatorExceptionType.STACK_UNDERFLOW,
                    "[xor] operation executed when stack had less than 2 entries.");
        }
