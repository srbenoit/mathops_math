 ...
 * The "ge" operator.
 * <p>
 * This operator pops two numbers from the stack, compares their numeric values, and pushes TRUE if the first is greater
 * than or equal to the second, or FALSE if not to the stack.
 */
public final class GeOperator extends AbstractOperator {

    /**
     * Constructs a new {code GeOperator}.
     */
    public GeOperator() {
    ...
    public final void execute(final OperatorStack stack) throws OperatorException {
        ...
        if (num1 == null || num2 == null) {
            throw new OperatorException(EOperatorExceptionType.STACK_UNDERFLOW,
                    "[ge] operation executed when stack had less than 2 entries.");
        }
        ...
        if (num1 instanceof Number arg1Nbr) {
            if (num2 instanceof Number arg2Nbr) {
                ...
                throw badType("Second argument", num1, "Number");
            }
        } else {
