 ...
 * The "ne" operator.
 * <p>
 * This operator pops two objects from the stack, tests whether they are equal, and then pushes FALSE if equal or TRUE
 * if unequal to the stack.
 */
public final class NeOperator extends AbstractOperator {

    /**
     * Constructs a new {code NeOperator}.
     */
    public NeOperator() {
    ...
    public final void execute(final OperatorStack stack) throws OperatorException {
        ...
        if (arg1 == null || arg2 == null) {
            throw new OperatorException(EOperatorExceptionType.STACK_UNDERFLOW,
                    "[ne] operation executed when stack had less than 2 entries.");
        }
