 ...
 * The "and" operator.
 * <p>
 * This operator pops two values from the stack.  If they are both Boolean, it computes their logical AND, and returns
 * that Boolean value to the stack.  If they are both Integers, it computes their bitwise AND and returns that integer
 * value to the stack.
 */
    ...
    public final void execute(final OperatorStack stack) throws OperatorException {
        ...
        if (arg1 == null || arg2 == null) {
            throw new OperatorException(EOperatorExceptionType.STACK_UNDERFLOW,
                    "[and] operation executed when stack had less than 2 entries.");
        }
